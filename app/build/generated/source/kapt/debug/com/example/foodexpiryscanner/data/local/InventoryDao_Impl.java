  ...
  public InventoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfInventoryItemEntity = new EntityInsertionAdapter<InventoryItemEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `inventory_items` (`id`,`remoteId`,`barcode`,`name`,`brand`,`category`,`quantity`,`expiryDate`,`imageUrl`,`isSynced`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfInventoryItemEntity = new EntityDeletionOrUpdateAdapter<InventoryItemEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `inventory_items` SET `id` = ?,`remoteId` = ?,`barcode` = ?,`name` = ?,`brand` = ?,`category` = ?,`quantity` = ?,`expiryDate` = ?,`imageUrl` = ?,`isSynced` = ? WHERE `id` = ?";
      }
      ...
      public List<InventoryItemEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _tmpIsSynced = _tmp != 0;
            _item = new InventoryItemEntity(_tmpId,_tmpRemoteId,_tmpBarcode,_tmpName,_tmpBrand,_tmpCategory,_tmpQuantity,_tmpExpiryDate,_tmpImageUrl,_tmpIsSynced);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public InventoryItemEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _tmp = _cursor.getInt(_cursorIndexOfIsSynced);
            _tmpIsSynced = _tmp != 0;
            _result = new InventoryItemEntity(_tmpId,_tmpRemoteId,_tmpBarcode,_tmpName,_tmpBrand,_tmpCategory,_tmpQuantity,_tmpExpiryDate,_tmpImageUrl,_tmpIsSynced);
          } else {
            _result = null;
          }
          return _result;
