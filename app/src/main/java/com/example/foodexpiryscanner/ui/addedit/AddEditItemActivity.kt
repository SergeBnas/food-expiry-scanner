...
class AddEditItemActivity : AppCompatActivity() {
    ...
    private fun openDatePicker() {
        ...
        DatePickerDialog(this, { _, year, month, dayOfMonth ->
            ...
            binding.tvDate.text = "Expiry date: $selectedDate"
    ...
    private fun fetchProduct(barcode: String) {
        lifecycleScope.launch {
            ...
            binding.tvStatus.text = "Loading product info..."
            try {
                ...
                if (response.isSuccessful && response.body()?.status == 1) {
                    ...
                    binding.tvStatus.text = "Product loaded. You can edit any field before saving."
                } else {
                    binding.tvStatus.text = "Product not found. Fill the fields manually."
                }
            } catch (_: Exception) {
                binding.tvStatus.text = "No internet. You can still save manually offline."
            }
